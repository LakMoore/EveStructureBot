  ...
  return [
    new ActionRowBuilder<ButtonBuilder>().addComponents(
      new ButtonBuilder()
        ...
        .setStyle(
          channel.starbaseFuel ? ButtonStyle.Success : ButtonStyle.Secondary,
        ),
    ),
    new ActionRowBuilder<ButtonBuilder>().addComponents(
      new ButtonBuilder()
        ...
        .setStyle(
          channel.starbaseStatus ? ButtonStyle.Success : ButtonStyle.Secondary,
        ),
    ),
    new ActionRowBuilder<ButtonBuilder>().addComponents(
      new ButtonBuilder()
        ...
        .setLabel(
          `Structure Fuel Alerts: ${channel.structureFuel ? "ON" : "OFF"}`,
        )
        .setStyle(
          channel.structureFuel ? ButtonStyle.Success : ButtonStyle.Secondary,
        ),
    ),
    new ActionRowBuilder<ButtonBuilder>().addComponents(
      new ButtonBuilder()
        ...
        .setLabel(
          `Structure Status Alerts: ${channel.structureStatus ? "ON" : "OFF"}`,
        )
        .setStyle(
          channel.structureStatus ? ButtonStyle.Success : ButtonStyle.Secondary,
        ),
    ),
    new ActionRowBuilder<ButtonBuilder>().addComponents(
      new ButtonBuilder()
        ...
        .setStyle(
          channel.miningUpdates ? ButtonStyle.Success : ButtonStyle.Secondary,
        ),
    ),
  ];
}
...
export const Configure: Command = {
  ...
  button: async (client: Client, interaction: ButtonInteraction) => {
    ...
    if (customId.startsWith("configure_toggle_")) {
      const feature = customId.split("_")[2] as
        | "starbaseFuel"
        | "starbaseStatus"
        | "structureFuel"
        | "structureStatus";
